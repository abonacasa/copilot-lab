---
mode: coding
description: 'Implement the feature described in the given plan using TDD and project conventions.'
model: GPT-4.1
---
...
2. Summarize your understanding before coding.
3. Start by generating **test cases first** based on the acceptance criteria and tasks in the plan.
